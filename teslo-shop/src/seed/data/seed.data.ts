...
export const SEED_DATA: SeedData = {
  products: [
    ...
    },
    {
      ...
      stock: 17,
      price: 35,
      sizes: [ProductSize.XS, ProductSize.S, ProductSize.XL, ProductSize.XXL],
    ...
    },
    {
      ...
      stock: 5,
      price: 30,
      sizes: [ProductSize.XS, ProductSize.S, ProductSize.XXL],
    ...
    },
    {
      ...
      stock: 12,
      price: 40,
      sizes: [ProductSize.XS, ProductSize.XXL],
    ...
    },
    {
      ...
      stock: 100,
      price: 85,
      sizes: [ProductSize.XS, ProductSize.L, ProductSize.XL, ProductSize.XXL],
    ...
    },
    {
      ...
      stock: 10,
      price: 130,
      sizes: [ProductSize.XS, ProductSize.S, ProductSize.M, ProductSize.XXL],
